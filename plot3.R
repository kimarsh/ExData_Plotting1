...
# here's the starting point for plot 3----
load("power2.R")

png(filename = "plot3.png", width = 480, height = 480, units = "px")

plot(Sub_metering_1 ~ DateTime, data = power2, 
     type = "l", col = "black",
     xlab = "",
     ylab = "Energy sub metering")
lines(Sub_metering_2 ~ DateTime, data = power2, col = "red")
lines(Sub_metering_3 ~ DateTime, data = power2, col = "blue")
